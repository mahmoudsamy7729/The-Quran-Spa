...
<main style="overflow-x: hidden">
    <div class="row justify-content-center"  style="padding-top: 2rem">
        <div class="col-md-3 col-6 d-flex justify-content-center rounded-pill p-2 themes-div" >
            <a role="button"  class="btn btn-primary col-6 rounded-pill tra-div "  style="background: none;border: none;outline: none;" href="{{route('surah-en',$data['id'])}}" wire:navigate>Translation</a>
            <a role="button"  class="btn btn-primary col-6 rounded-pill active-button tra-div" style="background: none;border: none;outline: none;" href="{{route('surah',$data['id'])}}" wire:navigate>Reading</a>
        </div>
        ...
        <div class="col-md-4 col-10 mt-3" style="font-family: quran;text-align:center">
            <h4 style="font-weight:bold;line-height: 2.5rem;" id="surah-text" wire:tansition>
